...
var T = defineComponent({
  ...
  setup(p, { emit: u }) {
    const i = p, e = u, a = ref(null), k = ref();
    provide("mapRef", k);
    const r = () => {
      const o = {
      ...
      if (k.value !== null) {
        ...
        o.markers.forEach((n) => {
          ...
          const s = new kakao.maps.Marker({
            ...
            draggable: typeof n.draggable == "boolean" ? n.draggable : false,
            clickable: typeof n.clickable == "boolean" ? n.clickable : false,
    ...
    return watch([() => i.lat, () => i.lng], ([o, d]) => {
      ...
      (o) => {
        var d, n;
        o === void 0 || o ? (d = k.value) == null || d.setDraggable(true) : (n = k.value) == null || n.setDraggable(false);
      }
    ), watch(
      () => i.level,
      (o) => {
      ...
      (o) => {
        var d, n;
        o === void 0 ? (d = k.value) == null || d.setZoomable(true) : (n = k.value) == null || n.setZoomable(o);
      }
    ), watch(
      () => i.projectionId,
      (o) => {
      ...
      (o) => {
        var d, n;
        o === void 0 ? (d = k.value) == null || d.setKeyboardShortcuts(false) : typeof o == "boolean" && ((n = k.value) == null || n.setKeyboardShortcuts(o));
      }
      ...
      i.markerList && i.markerCluster === void 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(i.markerList, (n, s) => (openBlock(), createBlock(unref($), {
      ...
      i.infoWindowList && i.markerCluster === void 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(i.infoWindowList, (n, s) => (openBlock(), createBlock(unref(B), {
        key: n.key === void 0 ? s : n.key,
        lat: n.lat,
        lng: n.lng,
        content: n.content,
...
var $ = defineComponent({
  ...
  setup(p, { emit: u }) {
    const i = u, e = p, a = ref(), k = inject("mapRef"), r = (s) => {
      if (s != null) {
    ...
    return onBeforeUnmount(() => {
      ...
      return openBlock(), createElementBlock("div", null, [
        s.$slots.infoWindow ? (openBlock(), createBlock(unref(B), {
          key: 0,
          marker: a.value,
          lat: e.lat,
          lng: e.lng,
          ...
          default: withCtx(() => [
            renderSlot(s.$slots, "infoWindow")
          ]),
          _: 3
        }, 8, ["marker", "lat", "lng", "visible"])) : e.infoWindow ? (openBlock(), createBlock(unref(B), {
          key: 1,
          marker: a.value,
          lat: e.lat,
          lng: e.lng,
        ...
        e.order ? (openBlock(), createBlock(unref(x), {
          key: 2,
          lat: e.lat,
          lng: e.lng,
          "y-anchor": 0,
...
var B = defineComponent({
  ...
  setup(p, { emit: u }) {
    const i = u, e = p, a = ref(), k = ref(), r = inject("mapRef"), m = (t) => {
      var o, d;
      if (e.lat === void 0 || e.lng === void 0)
    ...
    ), (t, l) => e.content && e.content.length > 0 || t.$slots.default ? (openBlock(), createElementBlock("div", G, [
...
var x = defineComponent({
  ...
  setup(p, { emit: u }) {
    ...
    ), (t, l) => e.content && e.content.length > 0 || t.$slots.default ? (openBlock(), createElementBlock("div", H, [
      t.$slots.default ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref_key: "contentSlot",
        ref: k
...
var E = defineComponent({
  ...
  setup(p) {
    const u = p, i = inject("mapRef");
    let e = null;
    const a = computed(() => u.latLngList.map((r) => new kakao.maps.LatLng(r.lat, r.lng))), k = (r) => {
    ...
    }), (r, m) => (openBlock(), createElementBlock("div", null, [
...
var q = defineComponent({
  ...
  setup(p) {
    const u = p, i = inject("mapRef"), e = ref([]), a = (t) => {
      e.value.push(t);
    }, k = (t) => {
    ...
    return (t, l) => (openBlock(), createElementBlock(Fragment, null, [
      u.markerList && unref(i) !== null ? (openBlock(), createElementBlock("div", U, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(u.markerList, (o, d) => (openBlock(), createBlock(unref($), {
          id: d,
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(u.markerList, (o, d) => (openBlock(), createElementBlock("div", { key: d }, [
          d !== u.markerList.length - 1 ? (openBlock(), createBlock(unref(E), {
            key: 0,
            latLngList: [
      ...
      u.markerList && u.showMarkerOrder ? (openBlock(), createElementBlock("div", V, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(u.markerList, (o, d) => (openBlock(), createBlock(unref(x), {
          key: d,
          lat: o.lat,
          lng: o.lng,
          "y-anchor": 0,
...
//# sourceMappingURL=chunk-KIZKPOT2.js.map
